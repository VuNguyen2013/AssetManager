...
{		
	...
	/// All custom implementations should be done in the <see cref="AssetGroupType"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class AssetGroupTypeServiceBase : ServiceBase<AssetGroupType, AssetGroupTypeKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="AssetGroupType"/> instance .
		///</summary>
		public AssetGroupTypeServiceBase() : base()
		{
		}
		...
		{
			AssetGroupType newEntityAssetGroupType = new AssetGroupType();
			newEntityAssetGroupType.Id  = _id;
			newEntityAssetGroupType.Name  = _name;
			return newEntityAssetGroupType;
		}
		#endregion Constructors

		#region Fields
		private static SecurityContext<AssetGroupType> securityContext = new SecurityContext<AssetGroupType>();
		...
		///</summary>
		public static SecurityContext<AssetGroupType> SecurityContext
		{
			get
			{
		...
		public override AssetGroupType Get(AssetGroupTypeKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{AssetGroupType}" /> from the datasource based on the primary key PK__AssetGro__3214EC077F60ED59 index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="AssetGroupType"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual AssetGroupType GetById(System.String _id)
		{
            ...
            {	
				...
				entity = dataProvider.AssetGroupTypeProvider.GetById(transactionManager, _id)   as AssetGroupType;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="AssetGroupType"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual AssetGroupType GetById(System.String _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.AssetGroupTypeProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as AssetGroupType;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="AssetGroupType" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<AssetGroupType> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
			...
			#region Initialisation
			TList<AssetGroupType> list = null;
			TransactionManager transactionManager = null; 
			NetTiersProvider dataProvider = null;
			#endregion Initialisation
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="AssetGroupType" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{AssetGroupType}"/> </returns>
		public virtual TList<AssetGroupType> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{AssetGroupType}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public virtual TList<AssetGroupType> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public virtual TList<AssetGroupType> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{AssetGroupType}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public override TList<AssetGroupType> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<AssetGroupType> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<AssetGroupType> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public virtual TList<AssetGroupType> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
        public virtual TList<AssetGroupType> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public virtual TList<AssetGroupType> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
        public virtual TList<AssetGroupType> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>AssetGroupType</c> objects.</returns>
		public virtual TList<AssetGroupType> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.AssetGroupTypeProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(AssetGroupType entity)
		{
            ...
            {	
				...
				result = dataProvider.AssetGroupTypeProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{AssetGroupType}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>AssetGroupType</c> objects in a <see cref="TList{AssetGroupType}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<AssetGroupType> Insert(TList<AssetGroupType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<AssetGroupType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(AssetGroupType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.AssetGroupTypeProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{AssetGroupType}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>AssetGroupType</c> objects in a <see cref="TList{AssetGroupType}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<AssetGroupType> Update(TList<AssetGroupType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<AssetGroupType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override AssetGroupType Save(AssetGroupType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.AssetGroupTypeProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{AssetGroupType}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>AssetGroupType</c> objects in a <see cref="TList{AssetGroupType}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<AssetGroupType> Save(TList<AssetGroupType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<AssetGroupType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(AssetGroupType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.AssetGroupTypeProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{AssetGroupType}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>AssetGroupType</c> objects in a <see cref="TList{AssetGroupType}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<AssetGroupType> Delete(TList<AssetGroupType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<AssetGroupType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(AssetGroupTypeKey key)
		{
		...
		public virtual bool Delete(System.String _id)
		{
			...
			try
            {
				...
				result = dataProvider.AssetGroupTypeProvider.Delete(transactionManager, _id);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="AssetGroupType"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="AssetGroupType"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual AssetGroupType DeepLoadById(System.String _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			AssetGroupType entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(AssetGroupType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(AssetGroupType entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(AssetGroupType entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="AssetGroupType"/> object to load.</param>
		...
		/// <param name="childTypes">AssetGroupType Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(AssetGroupType entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{AssetGroupType}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(AssetGroupType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{AssetGroupType}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<AssetGroupType> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{AssetGroupType}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(AssetGroupType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<AssetGroupType> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{AssetGroupType}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{AssetGroupType}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="AssetGroupType"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<AssetGroupType> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.AssetGroupTypeProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="AssetGroupType"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">AssetGroupType Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(AssetGroupType entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(AssetGroupType entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.AssetGroupTypeProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{AssetGroupType}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{AssetGroupType} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<AssetGroupType> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{AssetGroupType}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{AssetGroupType}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AssetGroupType Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<AssetGroupType> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.AssetGroupTypeProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
