<%@ Control Language="C#" ClassName="DepartmentUsedFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataRepresentative" runat="server" Text="Representative:" AssociatedControlID="dataRepresentative" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataRepresentative" Text='<%# Bind("Representative") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataRepresentative" runat="server" Display="Dynamic" ControlToValidate="dataRepresentative" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
